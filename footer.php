            <div class="footer bg-tan text-color-white text-align-center text-align-lg-left">
                <div class="container-xl">
                    <div class="row">
                        <div class="column-12 column-lg-5 order-2 order-lg-0">
                            <div class="row align-items-center">
                                <div class="column-12 column-lg-none order-1 order-lg-0 m-y-2">
                                    <img src="/wp-content/themes/iran-alive/assets/images/icon.png" alt="Iran Alive icon" />
                                </div>
                                <div class="column-12 column-lg order-0 order-lg-1 m-y-2">
                                    <div class="font-family-serif font-size-4 font-weight-500">Iran Alive</div>
                                    <div class="font-weight-500 line-height-3">
                                        PO Box 518 Melissa TX 75454<br />
                                        <a class="text-color-white" href="mailto:info@iranaliveministries.org">info@iranaliveministries.org</a><br />
                                        <a class="text-color-white d-md-none" href="tel:4699820000">(469) 982-0000</a>
                                        <span class="text-color-white d-none d-md-inline">(469) 982-0000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="column-12 column-lg-2 order-1"></div>
